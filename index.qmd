...
Installation Guide: 👉 <a href="lesson-materials/installation-guide.pdf" download>Download Install guide (EN) </a>
...
|                         |                                                                                                                                                                                          |
|                         | 👉 <a href="data-inputs.zip" download>Download data-inputs</a>                                                                                                                           |
|                         |                                                                                                                                                                                          |
|                         | 👉 <a href="scripts.zip" download>Download scripts</a>                                                                                                                                   |
+-------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
